...
answer_count int not null DEFAULT 0,
share_count int not null DE FAULT 0
);
...
create table article_responseinfo(
id int not null PRIMARY KEY auto_increment,
...
create table second_responsepostinfo
(
	id int not null PRIMARY KEY auto_increment,
	responsepost_id int not null DEFAULT 0,
	responsepost_username varchar(20) not null default '',
	second_responsepost_id int not null default 0,
	second_responsepost_username varchar(20) not null default '',
	second_responsepost_content longtext not null,
	second_responsepost_createtime datetime not null
